...
def main():
    ...
    # Folders to zip
    folders_to_zip = ['.agents', 'preferences', '.claude']
    ...
    try:
        ...
        print("This zip file includes the '.agents/', 'preferences/', and '.claude/' folders, offering users an easy way to set up manually.")
