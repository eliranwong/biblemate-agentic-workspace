...
- Always run the python retriever script located at `.claude/skills/characters/characters_query.py` to retrieve character data.
- Execute the script using: `python3 .claude/skills/characters/characters_query.py "<query>"` where `<query>` is the name of the character/person.
