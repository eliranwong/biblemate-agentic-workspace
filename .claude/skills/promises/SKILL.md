...
- Always run the python retriever script located at `.claude/skills/promises/promises_query.py` to retrieve the database promise records.
- Execute the script using: `python3 .claude/skills/promises/promises_query.py "<query>"` where `<query>` is the name or category of the promise.
