...
- Always run the python retriever script located at `.claude/skills/parallels/parallels_query.py` to retrieve the parallel passage groups.
- Execute the script using: `python3 .claude/skills/parallels/parallels_query.py "<query>"` where `<query>` is the topic, event, or name of the parallel.
