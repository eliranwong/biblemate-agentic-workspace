...
- Always run the python retriever script located at `.claude/skills/search/search_retriever.py` to perform the search.
- Execute the script using: `python3 .claude/skills/search/search_retriever.py "<query>"` where `<query>` is the input prompt or arguments.
