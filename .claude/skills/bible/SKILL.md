...
- Always run the python retriever script located at `.claude/skills/bible/bible_retriever.py` to retrieve the requested verses.
- Execute the script using: `python3 .claude/skills/bible/bible_retriever.py "<query>"` where `<query>` is the input prompt or arguments.
