...
- Always run the python retriever script located at `.claude/skills/search/search_retriever.py` with the `--book Obad` option to perform the search.
- Execute the script using: `python3 .claude/skills/search/search_retriever.py --book Obad "<query>"` where `<query>` is the input prompt or arguments.
