...
- Always run the python retriever script located at `.claude/skills/dictionaries/dictionaries_query.py` to retrieve dictionary records.
- Execute the script using: `python3 .claude/skills/dictionaries/dictionaries_query.py "<query>"` where `<query>` is the dictionary entry to search.
